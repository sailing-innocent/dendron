...
class FileStorage {
    ...
    async init() {
        ...
        try {
            ...
            if ((_a = this.config.dev) === null || _a === void 0 ? void 0 : _a.enableLinkCandidates) {
    ...
    async renameNote(opts) {
        ...
        const notesToUpdate = (await Promise.all(notesWithLinkTo.map(async (note) => {
            ...
            return out === null || out === void 0 ? void 0 : out.note;
        }))).filter(common_all_1.isNotUndefined);
    ...
    async writeNote(note, opts) {
        ...
        if (maybeNote && maybeNote.id === note.id) {
             ...
             */
            const deletedLinks = maybeNote.links.filter((link) => {
                var _a;
