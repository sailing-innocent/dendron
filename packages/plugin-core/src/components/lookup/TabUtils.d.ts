...
export interface TabGroups {
     ...
     */
    close(tabGroup: TabGroup | readonly TabGroup[], preserveFocus?: boolean): Promise<boolean>;
}
export declare class TabUtils {
    static tabAPIAvailable(): boolean;
    static isPreviewTab(tab: Tab): any;
    static getAllTabGroups(): TabGroups;
}
