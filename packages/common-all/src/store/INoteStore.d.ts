...
import { Disposable, DNoteLoc, NoteProps, NotePropsMeta, QueryNotesOpts, RespV3, WriteNoteMetaOpts, WriteNoteOpts } from "../types";
...
export interface INoteStore<K> extends Disposable {
     ...
     * @return List of NoteProps metadata that matches criteria
     */
    queryMetadata(opts: QueryNotesOpts): ResultAsync<NotePropsMeta[], IDendronError>;
}
