...
export interface IConfigStore {
     ...
     */
    createConfig(defaults?: DeepPartial<DendronConfig>): ResultAsync<DendronConfig, IDendronError>;
    /**
     ...
     */
    writeConfig(payload: DendronConfig): ResultAsync<DendronConfig, IDendronError>;
    /**
     * Given mode (workspace or global), read override config
     */
    readOverride(mode: "workspace" | "global"): ResultAsync<string, IDendronError>;
}
