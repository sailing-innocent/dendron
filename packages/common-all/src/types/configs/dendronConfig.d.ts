...
export type DendronConfigValue = string | boolean | number | DendronGlobalConfig | DendronCommandConfig | LookupConfig | RandomNoteConfig | InsertNoteLinkConfig | InsertNoteIndexConfig | CopyNoteLinkConfig | DendronWorkspaceConfig | {
