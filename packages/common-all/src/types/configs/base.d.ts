...
export type DendronConfigEntryCollection<T> = {
    [Property in keyof T]-?: DendronConfigEntryCollection<any> | Record<any, DendronConfigEntry> | DendronConfigEntry | ((...args: any[]) => DendronConfigEntry);
};
export declare enum VaultSyncModeEnum {
    skip = "skip",
    noPush = "noPush",
    noCommit = "noCommit",
    sync = "sync"
