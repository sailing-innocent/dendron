 ...
 */
export type PersistedAirtablePodConfig = AirtableV2PodConfig & Pick<ExternalTarget, "connectionId">;
/**
 * This is the set of parameters required for actual execution of the Pod
 */
export type RunnableAirtableV2PodConfig = Omit<AirtableV2PodConfig, "description" | "podType"> & Pick<AirtableConnection, "apiKey">;
/**
