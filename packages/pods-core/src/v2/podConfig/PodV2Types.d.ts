 ...
 */
export declare enum PodV2Types {
 ...
 */
export declare enum PodExportScope {
    Note = "Note",
    Lookup = "Lookup",
    Selection = "Selection",
    Hierarchy = "Hierarchy",
 ...
 * @returns
 */
export declare function isExportPodConfigurationV2(object: any): object is ExportPodConfigurationV2;
/**
